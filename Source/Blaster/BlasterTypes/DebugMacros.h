...
#define DRAW_SPHERE_PARAMS(Location,Radius,Color) if(GetWorld()) DrawDebugSphere(GetWorld(),Location,Radius,12,FColor::Color,false, 5.f);
#define DRAW_SPHERE_SINGLEFRAME(Location) if (GetWorld()) DrawDebugSphere(GetWorld(), Location, 25.f, 12, FColor::Red, false,-1.f);
#define DRAW_SPHERE_SINGLEFRAME_COLOR(Location, Color) if (GetWorld()) DrawDebugSphere(GetWorld(), Location, 25.f, 12, FColor::Color, false,-1.f);
...
#define DRAW_LINE_SINGLEFRAME_COLOR(StartLocation, EndLocation, Color) if (GetWorld()) DrawDebugLine(GetWorld(), StartLocation, EndLocation, FColor::Color, false, -1.f, 0, 1.f);
...
#define DRAW_POINT_SINGLEFRAME_COLOR(PointLocation, Color) if(GetWorld()) DrawDebugPoint(GetWorld(),PointLocation,15.f,FColor::Color, false, -1.f);
